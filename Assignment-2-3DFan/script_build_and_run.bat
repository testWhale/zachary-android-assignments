@echo off
REM =============================================================================
REM script_build_and_run.bat – Desktop build and run for Fan3D (Assignment 2)
REM
REM Prerequisites:
REM   - CMake 3.15+  in PATH
REM   - Visual Studio 2022 (or adjust the generator below)
REM   - Internet access (CMake downloads GLFW + GLEW + GLM via FetchContent)
REM
...
echo [3/3] Running ...
echo.
echo Tap/click toggles the fan. Click-drag to spin it faster. Press ESC to quit.
echo.
